...
const resources = is.development ? path.join(__dirname, '..', '..', 'resources') : process.resourcesPath
...
const PATH_TO_OMNISHARP_DIR = '/Users/jvoss/Projects/master-thesis/temp/omnisharp';
