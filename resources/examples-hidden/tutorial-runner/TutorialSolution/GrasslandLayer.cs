...
namespace SheepWolfStarter
{
    public class GrasslandLayer : RasterLayer
    {
            ...
            UnregisterAgent unregisterAgentHandle)
        {
            ...
            SheepEnvironment = new SpatialHashEnvironment<Sheep>(Width, Height) {CheckBoundaries = true};
            WolfEnvironment = new SpatialHashEnvironment<Wolf>(Width, Height) {CheckBoundaries = true};
